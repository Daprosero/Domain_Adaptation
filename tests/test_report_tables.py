...
REPORT = NOTEBOOKS / "Benchmark_Results.ipynb"
...
# of `Benchmark_Results.ipynb` shows a ladder of adjacent-arm differences any more.
...
#: the six required sections of `Benchmark_Results.ipynb`.
