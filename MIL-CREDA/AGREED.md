...
<!-- position revision=research-concept-r21.md sha256=cc55237fd6f7d9c6418a66671b64b87573cb5103465b31894fa1f1dc460178c2 derivedAt=2026-09-18T04:56:30Z session=52829b86 target=none -->
...
- [ ] 5. The attention mechanisms ran and their notebook is current against this source: the full method against ABMIL as published, ABMIL gated, max pooling at the instance level and mean pooling, on one configuration. Its rung is the rung of the run behind it. `@notebook:level Notebooks/Benchmark_Attention_Mechanisms.ipynb`
